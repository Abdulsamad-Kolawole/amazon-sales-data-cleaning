...
## Project Description This project focuses on cleaning and preparing the Amazon India Sales dataset for analysis using Microsoft Excel. The objective was to identify data quality issues, clean the dataset, and produce a version that is suitable for exploratory data analysis and visualization.

## Data Cleaning Tasks 
- Examined the dataset for data quality issues.
 - Removed duplicate records (none were found, if applicable).
